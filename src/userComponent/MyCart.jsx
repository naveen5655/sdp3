...
const MyCart = () => {
  ...
  const retrieveMyCart = async () => {
    const response = await axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/mycart?userId=" + user.id
    );
  ...
  const deleteProductFromCart = (cartId, e) => {
    const response = axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/mycart/remove?cartId=" + cartId
    );
