...
const AssignDeliveryToOrders = () => {
  ...
  const retrieveAllDeliveryPerson = async () => {
    const response = await axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/deliveryperson/all"
    );
  ...
  const retrieveAllOrder = async () => {
    const response = await axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/admin/showorder?orderId=" + orderId
    );
  ...
  const assignDeliveryToOrders = (e) => {
    fetch("https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/admin/order/assignDelivery", {
      method: "POST",
      headers: {
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        <img
                          src={
                            "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/product/" +
