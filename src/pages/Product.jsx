...
const Product = () => {
  ...
  const retrieveProduct = async () => {
    const response = await axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/product/id?productId=" + productId
    );
  ...
  const retrieveProductsByCategory = async () => {
    const response = await axios.get(
      "https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/product/category?categoryId=" + categoryId
    );
  ...
  const saveProductToCart = (userId) => {
    fetch("https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/user/cart/add", {
      method: "POST",
      headers: {
      ...
      <div class="row">
        ...
        <div class="col-sm-3 mt-2 admin">
          <div class="card form-card border-color custom-bg">
            <img
              src={"https://ec2-18-232-254-235.compute-1.amazonaws.com:8080/api/product/" + product.imageName}
              style={{
                maxHeight: "500px",
                maxWidth: "100%",
                width: "auto",
